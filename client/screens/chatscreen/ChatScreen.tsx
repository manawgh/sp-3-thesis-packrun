    ...
    <SafeAreaView style={{ flex: 1 }}>
        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <View style={{ flex: 1 }}>
                ...
                renderItem={({ item }) => (
                    <View>
                        <Text style={item.author === 'xXBobmanXx' ? styles.messageText : styles.messageText}>{item.author}</Text>
                        <View style={item.author === 'xXBobmanXx' ? styles.messageBubble : styles.messageBubble}>
